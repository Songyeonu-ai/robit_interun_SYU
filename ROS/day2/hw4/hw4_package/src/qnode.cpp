...
void QNode::topic_callback(const std_msgs::msg::String::SharedPtr msg) {
    ...
    if(msg->data=="CW"||msg->data=="cw"){
      emit receivedMessage_CW(QString::fromStdString(msg->data));
    }
    else if(msg->data=="CCW"||msg->data=="ccw"){
      emit receivedMessage_CCW(QString::fromStdString(msg->data));
    }
    else;
}
